                                ...
                                <div class="blog-style4">
                                    ...
                                    <div class="blog-content">
                                        ...
                                        @if ($post->post_type == 'post')
                                            <p>{{ \Illuminate\Support\Str::limit(strip_tags($post->post_content), 100) }}
                                            </p>
                                        @endif
                                    </div>
                                </div>
                ...
                <div class="col-xl-3 mt-35 mt-xl-0">
                    <div class="nav tab-menu indicator-active" role="tablist">
                        <button class="tab-btn active" id="nav-one-tab" data-bs-toggle="tab" data-bs-target="#nav-one"
                            ...
                            style="background-color: #FF1D50">Pages</button>
                    </div>
                            ...
                            <div class="widget">
                                <div class="nav tab-menu indicator-active" role="tablist">
                                    <button class="tab-btn active" id="nav-one-tab" data-bs-toggle="tab"
                                        ...
                                        aria-selected="true" style="background-color: #FF1D50">Recent Posts</button>
                                </div>
                    ...
                    <div class="nav tab-menu indicator-active" role="tablist">
                        <button class="tab-btn active" id="nav-one-tab" data-bs-toggle="tab" data-bs-target="#nav-one"
                            type="button" role="tab" aria-controls="nav-one" aria-selected="true"
                            style="background-color: #FF1D50">Category</button>
                    </div>
                    <div class="tab-content">
                        <div class="tab-pane fade show active" id="nav-one" role="tabpanel" aria-labelledby="nav-one-tab">
                            <div class="row gy-4">
